...
class ServiceExceptionTest {
	...
	private ServiceException exceptionWithCauseAndMessage;
	...
	void setup() {
		...
		exceptionWithCauseAndMessage = ServiceException.create(
				"This is the error message",
				new Exception("SubException", new Exception("SubSubException")));
	}
	...
	void testException() {
		...
		assertThat(exceptionWithCauseAndMessage).isNotNull();
		assertThat(exceptionWithCauseAndMessage.getCause().getMessage()).isEqualTo("SubException");
		assertThat(exceptionWithCause.getTechnicalDetails().getRootCode()).isEqualTo(BAD_GATEWAY.getStatusCode());
